    ...
    <div className="pt-24 pb-16">
      <div className="container mx-auto px-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground text-sm space-y-1">
                      <div>Mandag - Fredag: 07:00 - 16:00</div>
                      <div>Lørdag: 08:00 - 12:00</div>
            ...
            <Card className="bg-brand/5 border-brand/20">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  For akutte saker, ring oss direkte.
                </p>
              </CardContent>
            </Card>
          </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <p className="text-xs text-muted-foreground">
                  * Påkrevde felt. Vi behandler dine personopplysninger i henhold til vårt{" "}
                  <a href="/personvern" className="text-brand hover:underline">
                    personvernreglement
                  </a>
                  .
                </p>
        ...
        <div className="mt-16">
          <Card>
            <CardHeader>
              <CardTitle>Finn oss</CardTitle>
            </CardHeader>
            <CardContent className="p-0">
              <div className="aspect-[16/9] w-full">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2023.123456789!2d10.127334!3d59.270845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sLillevarskogen%204%2C%203160%20Stokke!5e0!3m2!1sno!2sno!4v1234567890"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="Rasmussen & Skjelbred lokasjon"
                />
              </div>
            </CardContent>
          </Card>
